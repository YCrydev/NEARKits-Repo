    ...
    object-fit: contain;" alt="">
                            ...
                            <div class="preview-item p-0">
                              <div class="preview-item-content d-flex flex-grow">
                                <div class="flex-grow">
                                  ...
                                  <h5 class="'.$text_color.'"><a class="'.$text_color.'" href="https://paras.id/search?q='.$collection_id.'">'.$collection.'</a></h5>
                                  ';
                                  $paginationHtml.='</div>
                      ...
                      <div class="card-footer d-flex justify-content-center">';
                                  if ($account_type ==="signed_in"){
                                      $paginationHtml.='
                                 <button class="btn btn-primary btn-sm transfer_nft" value="'.$token_id.'" contract_id="'.$contract_id.'" collection_name="'.$collection.'"  data-toggle="modal" data-target="#nft_transfer">Transfer</button>';
                                  }
                                  if(!$collection==null){
                                   $paginationHtml.='
                                 <a href="#activity" class="btn btn-dark btn-sm view_collection_activtiy" style="margin-left:auto" collection="'.$collection.'" collection_id="'.$collection_id.'"">Activity</a>';
                                  }
