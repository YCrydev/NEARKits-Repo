...
while($skip <=10){
    $type = "buy";
    $load_this = "https://api-v2-mainnet.paras.id/activities?__limit=90&to=".$account_id."&__skip=".($skip*30)."&type=market_sales";
    load_all_nfts($load_this,$type,$skip,$account_id);
    $skip = $skip+1;
}
$skip = 0;
while($skip <=10){
    $type = "sale";
    $load_this = "https://api-v2-mainnet.paras.id/activities?__limit=90&from=".$account_id."&__skip=".($skip*30)."&type=market_sales";
    load_all_nfts($load_this,$type,$skip,$account_id);
    $skip = $skip+1;
}
